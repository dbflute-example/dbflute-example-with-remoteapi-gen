 ...
 */
package org.docksidestage.remote.petstore.defetc.sea.land.user;
...
import org.docksidestage.remote.petstore.defetc.sea.land.user.index.RemoteUserReturn;
import org.docksidestage.remote.petstore.defetc.sea.land.user.login.RemoteUserLoginParam;
 ...
 * @author FreeGen
 */
public class RemotePetstoreDefetcSeaUserBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemotePetstoreDefetcSeaUserBhvTest.class);
    ...
    private RemotePetstoreDefetcSeaUserBhv createBhv(String json) {
        ...
        registerMock(client);
        RemotePetstoreDefetcSeaUserBhv bhv = new RemotePetstoreDefetcSeaUserBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
