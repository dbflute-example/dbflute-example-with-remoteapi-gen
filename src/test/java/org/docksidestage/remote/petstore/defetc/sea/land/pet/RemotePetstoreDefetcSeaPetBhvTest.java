 ...
 */
package org.docksidestage.remote.petstore.defetc.sea.land.pet;
...
import org.docksidestage.remote.petstore.defetc.sea.land.pet.findbystatus.RemotePetFindbystatusParam;
import org.docksidestage.remote.petstore.defetc.sea.land.pet.findbystatus.RemotePetFindbystatusReturn;
import org.docksidestage.remote.petstore.defetc.sea.land.pet.findbytags.RemotePetFindbytagsParam;
import org.docksidestage.remote.petstore.defetc.sea.land.pet.findbytags.RemotePetFindbytagsReturn;
import org.docksidestage.remote.petstore.defetc.sea.land.pet.index.RemotePetReturn;
 ...
 * @author FreeGen
 */
public class RemotePetstoreDefetcSeaPetBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemotePetstoreDefetcSeaPetBhvTest.class);
    ...
    private RemotePetstoreDefetcSeaPetBhv createBhv(String json) {
        ...
        registerMock(client);
        RemotePetstoreDefetcSeaPetBhv bhv = new RemotePetstoreDefetcSeaPetBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
