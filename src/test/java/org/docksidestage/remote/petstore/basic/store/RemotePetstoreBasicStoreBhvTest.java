 ...
 */
package org.docksidestage.remote.petstore.basic.store;
...
import org.docksidestage.remote.petstore.basic.store.order.RemoteStoreOrderGetReturn;
import org.docksidestage.remote.petstore.basic.store.order.RemoteStoreOrderParam;
import org.docksidestage.remote.petstore.basic.store.order.RemoteStoreOrderReturn;
 ...
 * @author FreeGen
 */
public class RemotePetstoreBasicStoreBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemotePetstoreBasicStoreBhvTest.class);
    ...
    private RemotePetstoreBasicStoreBhv createBhv(String json) {
        ...
        registerMock(client);
        RemotePetstoreBasicStoreBhv bhv = new RemotePetstoreBasicStoreBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
