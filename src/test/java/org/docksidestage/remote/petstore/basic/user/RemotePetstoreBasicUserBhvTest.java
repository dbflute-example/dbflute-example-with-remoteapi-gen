 ...
 */
package org.docksidestage.remote.petstore.basic.user;
...
import org.docksidestage.remote.petstore.basic.user.createwitharray.RemoteUserCreatewitharrayParam;
import org.docksidestage.remote.petstore.basic.user.createwithlist.RemoteUserCreatewithlistParam;
import org.docksidestage.remote.petstore.basic.user.index.RemoteUserGetReturn;
import org.docksidestage.remote.petstore.basic.user.index.RemoteUserParam;
import org.docksidestage.remote.petstore.basic.user.index.RemoteUserPutParam;
import org.docksidestage.remote.petstore.basic.user.login.RemoteUserLoginParam;
 ...
 * @author FreeGen
 */
public class RemotePetstoreBasicUserBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemotePetstoreBasicUserBhvTest.class);
    ...
    private RemotePetstoreBasicUserBhv createBhv(String json) {
        ...
        registerMock(client);
        RemotePetstoreBasicUserBhv bhv = new RemotePetstoreBasicUserBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
