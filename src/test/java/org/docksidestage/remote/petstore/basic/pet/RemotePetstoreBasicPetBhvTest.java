 ...
 */
package org.docksidestage.remote.petstore.basic.pet;
...
import org.docksidestage.remote.petstore.basic.pet.findbystatus.RemotePetFindbystatusParam;
import org.docksidestage.remote.petstore.basic.pet.findbystatus.RemotePetFindbystatusReturn;
import org.docksidestage.remote.petstore.basic.pet.findbytags.RemotePetFindbytagsParam;
import org.docksidestage.remote.petstore.basic.pet.findbytags.RemotePetFindbytagsReturn;
import org.docksidestage.remote.petstore.basic.pet.index.RemotePetGetReturn;
import org.docksidestage.remote.petstore.basic.pet.index.RemotePetPetidPostParam;
import org.docksidestage.remote.petstore.basic.pet.index.RemotePetPostParam;
import org.docksidestage.remote.petstore.basic.pet.index.RemotePetPutParam;
import org.docksidestage.remote.petstore.basic.pet.uploadimage.RemotePetUploadimageParam;
import org.docksidestage.remote.petstore.basic.pet.uploadimage.RemotePetUploadimageReturn;
 ...
 * @author FreeGen
 */
public class RemotePetstoreBasicPetBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemotePetstoreBasicPetBhvTest.class);
    ...
    private RemotePetstoreBasicPetBhv createBhv(String json) {
        ...
        registerMock(client);
        RemotePetstoreBasicPetBhv bhv = new RemotePetstoreBasicPetBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
