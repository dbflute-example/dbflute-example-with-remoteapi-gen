...
/**
 * The behavior test for remote API of wx.routing.restlike.next.nextnext.
 * @author FreeGen
 */
public class RemoteFortressWxRoutingRestlikeNextNextnextBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemoteFortressWxRoutingRestlikeNextNextnextBhvTest.class);
    ...
    private RemoteFortressWxRoutingRestlikeNextNextnextBhv createBhv(String json) {
        ...
        registerMock(client);
        RemoteFortressWxRoutingRestlikeNextNextnextBhv bhv = new RemoteFortressWxRoutingRestlikeNextNextnextBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
