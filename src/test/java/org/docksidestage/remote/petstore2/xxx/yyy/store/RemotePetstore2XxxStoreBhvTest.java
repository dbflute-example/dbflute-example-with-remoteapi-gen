 ...
 * @author FreeGen
 */
public class RemotePetstore2XxxStoreBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemotePetstore2XxxStoreBhvTest.class);
    ...
    private RemotePetstore2XxxStoreBhv createBhv(String json) {
        ...
        registerMock(client);
        RemotePetstore2XxxStoreBhv bhv = new RemotePetstore2XxxStoreBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
