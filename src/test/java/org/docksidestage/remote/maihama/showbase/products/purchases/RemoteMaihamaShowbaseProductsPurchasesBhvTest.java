...
import org.docksidestage.remote.maihama.showbase.products.purchases.index.RemoteProductsProductidPurchasesPurchaseidReturn;
import org.docksidestage.remote.maihama.showbase.products.purchases.index.RemoteProductsPurchasesParam;
import org.docksidestage.remote.maihama.showbase.products.purchases.index.RemoteProductsPurchasesReturn;
 ...
 * @author FreeGen
 */
public class RemoteMaihamaShowbaseProductsPurchasesBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemoteMaihamaShowbaseProductsPurchasesBhvTest.class);
    ...
    private RemoteMaihamaShowbaseProductsPurchasesBhv createBhv(String json) {
        ...
        registerMock(client);
        RemoteMaihamaShowbaseProductsPurchasesBhv bhv = new RemoteMaihamaShowbaseProductsPurchasesBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
