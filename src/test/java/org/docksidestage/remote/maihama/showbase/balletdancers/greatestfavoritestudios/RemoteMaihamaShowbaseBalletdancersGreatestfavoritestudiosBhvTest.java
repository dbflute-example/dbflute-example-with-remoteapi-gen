 ...
 * @author FreeGen
 */
public class RemoteMaihamaShowbaseBalletdancersGreatestfavoritestudiosBhvTest extends UnitRemoteapigenTestCase {

    private static final Logger logger = LoggerFactory.getLogger(RemoteMaihamaShowbaseBalletdancersGreatestfavoritestudiosBhvTest.class);
    ...
    private RemoteMaihamaShowbaseBalletdancersGreatestfavoritestudiosBhv createBhv(String json) {
        ...
        registerMock(client);
        RemoteMaihamaShowbaseBalletdancersGreatestfavoritestudiosBhv bhv =
                new RemoteMaihamaShowbaseBalletdancersGreatestfavoritestudiosBhv(requestManager);
        inject(bhv);
        return bhv;
    }
}
