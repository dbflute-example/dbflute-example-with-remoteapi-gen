 ...
 * @author FreeGen
 */
public abstract class BsRemotePetstoreBasicUserBhv extends AbstractRemotePetstoreBasicBhv {
     ...
     */
    public BsRemotePetstoreBasicUserBhv(RequestManager requestManager) {
