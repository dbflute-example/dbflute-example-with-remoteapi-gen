 ...
 * @author FreeGen
 */
public abstract class BsRemotePetstoreBasicStoreBhv extends AbstractRemotePetstoreBasicBhv {
     ...
     */
    public BsRemotePetstoreBasicStoreBhv(RequestManager requestManager) {
