 ...
 */
package org.docksidestage.remote.fortress.member.list;

import org.lastaflute.core.util.Lato;

/**
 * The bean class as param for remote API of GET /member/list/{pageNumber}.
 * @author FreeGen
 */
public class RemoteMemberListPagenumberParam {
