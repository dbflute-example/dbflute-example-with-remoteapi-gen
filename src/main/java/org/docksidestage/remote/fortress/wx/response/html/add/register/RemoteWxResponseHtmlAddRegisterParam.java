 ...
 */
package org.docksidestage.remote.fortress.wx.response.html.add.register;

import org.lastaflute.core.util.Lato;
import org.lastaflute.web.validation.Required;

/**
 * The bean class as param for remote API of GET /wx/response/html/add/register.
 * @author FreeGen
 */
public class RemoteWxResponseHtmlAddRegisterParam {
