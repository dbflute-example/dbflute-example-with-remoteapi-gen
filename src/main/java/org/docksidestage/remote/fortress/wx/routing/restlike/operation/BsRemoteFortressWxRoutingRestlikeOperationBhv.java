...
/**
 * The base class as generation gap for remote API of wx.routing.restlike.operation.
 * @author FreeGen
 */
public abstract class BsRemoteFortressWxRoutingRestlikeOperationBhv extends AbstractRemoteFortressBhv {
     ...
     */
    public BsRemoteFortressWxRoutingRestlikeOperationBhv(RequestManager requestManager) {
    ...
    //                                                                             =======
    /**
     * Request remote call to /wx/routing/restlike/{first}/operation. (auto-generated method)<br>
     * <pre>
     * url: /wx/routing/restlike/{first}/operation
     * httpMethod: GET
     * </pre>
    ...
    /**
     * Set up method-level rule of /wx/routing/restlike/{first}/operation.<br>
