 ...
 */
package org.docksidestage.remote.fortress.wx.message;

import org.lastaflute.core.util.Lato;

/**
 * The bean class as param for remote API of GET /wx/message/{pageNumber}.
 * @author FreeGen
 */
public class RemoteWxMessagePagenumberParam {
