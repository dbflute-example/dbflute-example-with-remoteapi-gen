 ...
 */
package org.docksidestage.remote.fortress.product.list;

import org.lastaflute.core.util.Lato;

/**
 * The bean class as param for remote API of GET /product/list/{pageNumber}.
 * @author FreeGen
 */
public class RemoteProductListPagenumberParam {
