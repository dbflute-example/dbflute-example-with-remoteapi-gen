...
import org.docksidestage.remote.fortress.products.showbaseoneman.index.RemoteProductsProductidShowbaseonemanGetReturn;
...
public abstract class BsRemoteFortressProductsShowbaseonemanBhv extends AbstractRemoteFortressBhv {
     ...
     */
    public RemoteProductsProductidShowbaseonemanGetReturn requestGet(Integer productId) {
     ...
     * @return The bean object as return type, receiving response body. (NotNull)
     */
    protected RemoteProductsProductidShowbaseonemanGetReturn doRequestGet(Integer productId, Consumer<FlutyRemoteApiRule> ruleLambda) {
        return doRequestGet(RemoteProductsProductidShowbaseonemanGetReturn.class, "/products/{productId}/showbase-oneman/", moreUrl(productId), noQuery(), rule -> {
