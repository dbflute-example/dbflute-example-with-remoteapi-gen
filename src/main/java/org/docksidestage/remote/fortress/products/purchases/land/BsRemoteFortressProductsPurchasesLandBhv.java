...
import org.docksidestage.remote.fortress.products.purchases.land.index.RemoteProductsProductidPurchasesPurchaseidLandGetReturn;
...
public abstract class BsRemoteFortressProductsPurchasesLandBhv extends AbstractRemoteFortressBhv {
     ...
     */
    public RemoteProductsProductidPurchasesPurchaseidLandGetReturn requestGet(Integer productId, Long purchaseId) {
     ...
     * @return The bean object as return type, receiving response body. (NotNull)
     */
    protected RemoteProductsProductidPurchasesPurchaseidLandGetReturn doRequestGet(Integer productId, Long purchaseId, Consumer<FlutyRemoteApiRule> ruleLambda) {
        return doRequestGet(RemoteProductsProductidPurchasesPurchaseidLandGetReturn.class, "/products/{productId}/purchases/{purchaseId}/land/", moreUrl(productId, purchaseId), noQuery(), rule -> {
