 ...
 * @author FreeGen
 */
public abstract class BsRemoteFortressProfileBhv extends AbstractRemoteFortressBhv {
     ...
     */
    public BsRemoteFortressProfileBhv(RequestManager requestManager) {
    ...
    protected String doRequest(Consumer<FlutyRemoteApiRule> ruleLambda) {
        return doRequestGet(String.class, "/profile/", noMoreUrl(), noQuery(), rule -> {
            ruleOf(rule);
