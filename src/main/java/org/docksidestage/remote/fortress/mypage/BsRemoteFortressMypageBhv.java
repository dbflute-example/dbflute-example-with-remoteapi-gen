 ...
 * @author FreeGen
 */
public abstract class BsRemoteFortressMypageBhv extends AbstractRemoteFortressBhv {
     ...
     */
    public BsRemoteFortressMypageBhv(RequestManager requestManager) {
    ...
    protected String doRequest(Consumer<FlutyRemoteApiRule> ruleLambda) {
        return doRequestGet(String.class, "/mypage/", noMoreUrl(), noQuery(), rule -> {
            ruleOf(rule);
