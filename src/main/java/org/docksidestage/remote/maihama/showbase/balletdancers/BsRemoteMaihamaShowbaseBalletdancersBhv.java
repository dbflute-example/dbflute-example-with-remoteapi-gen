 ...
 * @author FreeGen
 */
public abstract class BsRemoteMaihamaShowbaseBalletdancersBhv extends AbstractRemoteMaihamaShowbaseBhv {
     ...
     */
    public BsRemoteMaihamaShowbaseBalletdancersBhv(RequestManager requestManager) {
