 ...
 * @author FreeGen
 */
public abstract class BsRemoteMaihamaShowbaseProductsPurchasesBhv extends AbstractRemoteMaihamaShowbaseBhv {
     ...
     */
    public BsRemoteMaihamaShowbaseProductsPurchasesBhv(RequestManager requestManager) {
