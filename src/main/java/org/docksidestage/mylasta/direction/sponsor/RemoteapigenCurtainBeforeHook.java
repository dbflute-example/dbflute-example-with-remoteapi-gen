 ...
 * @author jflute
 */
public class RemoteapigenCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = RemoteapigenUserTimeZoneProcessProvider.centralTimeZone;
