 ...
 * @author jflute
 */
public class RemoteapigenSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public RemoteapigenSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
