...
public interface CDef extends Classification {
     ...
     */
    public enum WhiteConfusingFormatBodying implements CDef {
        /** sea */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return CDef.DefMeta.WhiteConfusingFormatBodying; }
    ...
    public enum DefMeta implements ClassificationMeta {
        ...
        public OptionalThing<? extends Classification> of(Object code) {
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return CDef.WhiteConfusingFormatBodying.of(code); }
        ...
        public OptionalThing<? extends Classification> byName(String name) {
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return CDef.WhiteConfusingFormatBodying.byName(name); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public Classification codeOf(Object code) { // null if not found, old style so use of(code)
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return CDef.WhiteConfusingFormatBodying.codeOf(code); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public Classification nameOf(String name) { // null if not found, old style so use byName(name)
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return CDef.WhiteConfusingFormatBodying.valueOf(name); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public List<Classification> listAll() {
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return toClsList(CDef.WhiteConfusingFormatBodying.listAll()); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public List<Classification> listByGroup(String groupName) { // exception if not found
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return toClsList(CDef.WhiteConfusingFormatBodying.listByGroup(groupName)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public List<Classification> listOf(Collection<String> codeList) {
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return toClsList(CDef.WhiteConfusingFormatBodying.listOf(codeList)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public List<Classification> groupOf(String groupName) { // old style
            ...
            if (WhiteConfusingFormatBodying.name().equals(name())) { return toClsList(CDef.WhiteConfusingFormatBodying.groupOf(groupName)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public static OptionalThing<CDef.DefMeta> find(String classificationName) { // instead of valueOf()
            ...
            if (WhiteConfusingFormatBodying.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(CDef.DefMeta.WhiteConfusingFormatBodying); }
        ...
        public static CDef.DefMeta meta(String classificationName) { // old style so use find(name)
            ...
            if (WhiteConfusingFormatBodying.name().equalsIgnoreCase(classificationName)) { return CDef.DefMeta.WhiteConfusingFormatBodying; }
