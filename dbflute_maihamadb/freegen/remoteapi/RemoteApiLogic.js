...
var remoteApiLogic = {
     ...
     * Unique and sort importClassList. And return the import declaration separated by top package.
     * @param {string[]} importClassList The list of import class.
     * @param {string} currentPackage Package name of the class to declare import.
     * @param {string[]} importTopPackageOrderList The order list of top packages of import declaration.
     * @return import declaration. (NotNull)
     */
    importDeclaration: function(importClassList, currentPackage, importTopPackageOrderList) {
        // Unique importClass.
        ...
        uniqueImportClassList.forEach(function(importClass) {
            ...
            importDeclaration += 'import ' + importClass + ';\n';
        });
